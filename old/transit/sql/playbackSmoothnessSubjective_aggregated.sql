SELECT AVG((sl.sessionLength - stDelay.val)/((sl.sessionLength - stDelay.val) + (stNumber.val * stDuration.val)*(stNumber.val * stDuration.val))) as playbackSmoothness FROM
	(
